...
if __name__ == "__main__":
    ...
    print ("len(game._board_state) %s" % len(game._board_state))


    print("\nNew state:\n{}".format(new_game.to_string()))
    print (new_game.get_player_location(player1))
    print (new_game.get_player_location(player2))
    print (new_game._board_state)
    print ("len(new_game._board_state) %s" %len(new_game._board_state))
